...
set rst_name [lindex $argv 2]
set rst_time [lindex $argv 3]
...
file copy -force ${basedir}/input_files/domain_inputs/usfs_vegm.dat drv_vegm.dat
file copy -force ${basedir}/input_files/domain_inputs/usfs_indicator.pfb ${runname}_indicator.pfb
#------------------------------------------------------------------------------------------------
file copy -force ${basedir}/output_files/${rundir}/${rst_name}/${rst_name}.out.press.${rst_time}.pfb press.init.pfb
file copy -force ${basedir}/output_files/${rundir}/${rst_name}/clm.rst.00000.0 .
file copy -force ${basedir}/output_files/${rundir}/${rst_name}/clm.rst.00000.1 .
file copy -force ${basedir}/output_files/${rundir}/${rst_name}/clm.rst.00000.2 .
file copy -force ${basedir}/output_files/${rundir}/${rst_name}/clm.rst.00000.3 .
#------------------------------------------------------------------------------------------------
puts "Files Copied"
#------------------------------------------------------------------------------------------------
